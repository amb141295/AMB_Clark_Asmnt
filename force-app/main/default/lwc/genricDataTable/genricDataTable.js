...
export default class GenricDataTable extends LightningElement {
    ...
    @api hideCheckboxCol = false; // Boolean to hide check box column
    ...
    connectedCallback() {
        ...
        this.selectedDataProp = this.hideCheckboxCol === true ? HIDEDIV : SHOWDIV;
